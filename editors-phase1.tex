...
%    \node[action] (assignvolume1) at (0,-4) {\begin{tabular}{c}\textcolor{blue}{Editors in chief}\\ assign to the volume ``Phase 1''\end{tabular}};
    ...
    \node[action] (announceeditors) at (5,-12) {\begin{tabular}{c}\textcolor{blue}{Editors in chief}\\ add a comment to \\ announce the editors\end{tabular}};
    \node[action] (answerreview) at (0,-14) {\begin{tabular}{c}\textcolor{blue}{Reviewers}\\ answer the review request \end{tabular}};
    \node[action] (sendreview) at (0,-16) {\begin{tabular}{c}\textcolor{blue}{Reviewers}\\ send the review\end{tabular}};
...
%    \draw[->] (assignvolume1) edge (assigneditors) ;
    ...
    \draw[dashed,->] (declarecoi) edge (announceeditors) ;
