...
\centering
  \begin{tikzpicture}[scale=1]
    ...
    \node[action] (movephase2) at (2,-2.5) {\begin{tabular}{c}\textcolor{blue}{Editors in chief}\\ create a new version to initiate Phase 2\\ write a message to the editors\end{tabular}};
    \node[action] (invitereviewers) at (2,-4.5) {\begin{tabular}{c}\textcolor{blue}{Assigned editors}\\ invite reviewers \end{tabular}};
    \node[action] (answerinvitation) at (2,-7) {\begin{tabular}{c}\textcolor{blue}{Reviewers}\\ answer the review request \end{tabular}};
    \node[action] (sendreview) at (2,-9) {\begin{tabular}{c}\textcolor{blue}{Reviewers}\\ send the review \end{tabular}};
    ...
    \draw[dashed, ->] (recommendation) edge node[below,yshift=0.1cm] {\begin{tabular}{c} \tiny{\color{red}Major revision request}\\[-.5em] \tiny{\color{red}OR Minor revisions request}
    \\[-.5em] \tiny{\color{red}\textit{option}: ``automatically reinvite reviewers''}
    \end{tabular}} node[above] {ask for revision} (submitrevised) ;
